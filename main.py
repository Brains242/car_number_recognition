...
from DetectPlates import DetectChars
import DetectPlates
from DetectPlates import PossiblePlate
...
def main():
    ...
    imgOriginalScene = cv2.imread("LicPlateImages/tractor_1995.jpg")  # open image
...
def drawRedRectangleAroundPlate(imgOriginalScene, licPlate):
    p2fRectPoints = cv2.boxPoints(licPlate.rrLocationOfPlateInScene).astype(int)  # get 4 vertices of rotated rect
